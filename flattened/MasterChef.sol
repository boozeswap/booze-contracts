...
// File: contracts\BoozeToken.sol

pragma solidity 0.6.12;


// BoozeToken with Governance.
contract BoozeToken is BEP20('BOOZE TOKEN', 'BOOZE') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BOOZE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BOOZE::delegateBySig: invalid nonce");
        require(now <= expiry, "BOOZE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BOOZE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BOOZEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BOOZE::_writeCheckpoint: block number exceeds 32 bits");
